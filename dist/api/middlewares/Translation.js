...
async function initTranslation(router) {
    const languages = fs_1.default.readdirSync(path_1.default.join(ASSET_FOLDER_PATH, "locales"));
    const namespaces = fs_1.default.readdirSync(path_1.default.join(ASSET_FOLDER_PATH, "locales", "en"));
    const ns = namespaces
    ...
    await i18next_1.default
        ...
        ns,
        backend: {
            loadPath: path_1.default.join(ASSET_FOLDER_PATH, "locales") +
                "/{{lng}}/{{ns}}.json",
        },
        load: "all",
    });
