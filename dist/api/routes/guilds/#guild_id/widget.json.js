...
router.get("/", (0, api_1.route)({}), async (req, res) => {
    ...
    let invite = await util_1.Invite.findOne({
    ...
    if (guild.widget_channel_id && !invite) {
        ...
        invite = await util_1.Invite.create({
            code: (0, api_1.random)(),
            temporary: false,
            uses: 0,
            max_uses: 0,
    ...
    const members = await util_1.Member.find({ where: { guild_id: guild_id } });
