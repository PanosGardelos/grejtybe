...
let Guild = Guild_1 = class Guild extends BaseClass_1.BaseClass {
    ...
    features = __1.Config.get().guild.defaultFeatures || []; //TODO use enum
    //TODO: https://discord.com/developers/docs/resources/guild#guild-object-guild-features
    primary_category_id; // TODO: this was number?
    icon;
    large = false;
    max_members = __1.Config.get().limits.guild.maxMembers;
    max_presences = __1.Config.get().defaults.guild.maxPresences;
    max_video_channel_users = __1.Config.get().defaults.guild.maxVideoChannelUsers;
    member_count;
    ...
    premium_tier; // crowd premium level
    ...
    static async createGuild(body) {
        ...
        const guild = await Guild_1.create({
            id: guild_id,
        ...
        for (const channel of body.channels.sort((a) => a.parent_id ? 1 : -1)) {
            const id = ids.get(channel.id) || __1.Snowflake.generate();
