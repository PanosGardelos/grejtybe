...
async function download(url, dir) {
    try {
        ...
        await promises_1.default.writeFile(path_1.default.join(tempDir, "Fosscord.zip"), buffer);
    }
    catch (error) {
...
async function getCurrentVersion(dir) {
    try {
        const content = await promises_1.default.readFile(path_1.default.join(dir, "package.json"), {
            encoding: "utf8",
        });
