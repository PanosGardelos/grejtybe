...
class Rights extends BitField_1.BitField {
    ...
    static FLAGS = {
        ...
        CREDITABLE: (0, BitField_2.BitFlag)(32),
        KICK_BAN_MEMBERS: (0, BitField_2.BitFlag)(33),
        // can kick or ban guild or group DM members in the guilds/groups that they have KICK_MEMBERS, or BAN_MEMBERS
        SELF_LEAVE_GROUPS: (0, BitField_2.BitFlag)(34),
        ...
        PRESENCE: (0, BitField_2.BitFlag)(35),
        // inverts the presence confidentiality default (OPERATOR's presence is not routed by default, others' are) for a given user
        SELF_ADD_DISCOVERABLE: (0, BitField_2.BitFlag)(36),
        MANAGE_GUILD_DIRECTORY: (0, BitField_2.BitFlag)(37),
        POGGERS: (0, BitField_2.BitFlag)(38),
        USE_ACHIEVEMENTS: (0, BitField_2.BitFlag)(39),
        INITIATE_INTERACTIONS: (0, BitField_2.BitFlag)(40),
        RESPOND_TO_INTERACTIONS: (0, BitField_2.BitFlag)(41),
        SEND_BACKDATED_EVENTS: (0, BitField_2.BitFlag)(42),
        USE_MASS_INVITES: (0, BitField_2.BitFlag)(43),
        ACCEPT_INVITES: (0, BitField_2.BitFlag)(44),
        SELF_EDIT_FLAGS: (0, BitField_2.BitFlag)(45),
        EDIT_FLAGS: (0, BitField_2.BitFlag)(46),
        MANAGE_GROUPS: (0, BitField_2.BitFlag)(47),
        VIEW_SERVER_STATS: (0, BitField_2.BitFlag)(48), // added per @chrischrome's request — can view server stats)
    };
    any(permission, checkOperator = true) {
        return ((checkOperator && super.any(Rights.FLAGS.OPERATOR)) ||
            super.any(permission));
    }
    has(permission, checkOperator = true) {
        return ((checkOperator && super.has(Rights.FLAGS.OPERATOR)) ||
            super.has(permission));
    }
    hasThrow(permission) {
        if (this.has(permission))
            return true;
        throw new lambert_server_1.HTTPError(`You are missing the following rights ${permission}`, 403);
    }
}
exports.Rights = Rights;
const ALL_RIGHTS = Object.values(Rights.FLAGS).reduce((total, val) => total | val, BigInt(0));
async function getRights(user_id) {
    const user = await entities_1.User.findOneOrFail({ where: { id: user_id } });
